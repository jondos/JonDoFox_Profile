...
var XpiInstaller = {
	...
	extFullName: 'CacheIt!', // The name displayed to the user (don't include the version)
	extShortName: 'cacheit', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.9.8',
	extAuthor: 'Selby Kendrick',
