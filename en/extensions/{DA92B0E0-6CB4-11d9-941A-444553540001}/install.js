...
var XpiInstaller = {
	...
	extFullName: 'Enhanced Bookmark Search (Preview Release)', // The name displayed to the user (don't include the version)
	extShortName: 'bcpm', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1.4.04',
	extAuthor: 'AnonEmoose',
	extLocaleNames: ['en-US', 'zh-TW', 'it-IT', 'es-ES', 'de-DE', 'fr-FR', 'nl-NL', 'ru-RU', 'sk-SK', 'ko-KR', 'pt-BR', 'zh-CN', 'da-DK'], // e.g. ['en-US', 'en-GB'] Set to null for nothing  ['en-US']
	extSkinNames: ['classic'], // e.g. ['classic', 'modern'] Set to null for nothing ['classic']
