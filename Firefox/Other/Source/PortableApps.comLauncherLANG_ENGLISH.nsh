...
LangString LauncherAlreadyRunning ${LANG_ENGLISH} "Another instance of Firefox is already running. Would you like to close Firefox and continue starting ${APPNAME}?"
LangString LauncherCouldNotCloseRunning ${LANG_ENGLISH} "Could not close Firefox! Error code: $R0"
