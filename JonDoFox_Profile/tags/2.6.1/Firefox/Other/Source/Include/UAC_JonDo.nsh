...
!insertmacro _UAC.TryDef UACSTR.${_modeprefix}ElvWinErr $(ElvError)
!ifNdef __UNINSTALL__
	!insertmacro _UAC.TryDef UACSTR.${_modeprefix}ElvAbortReqAdmin $(ElvAbort)
	!insertmacro _UAC.TryDef UACSTR.${_modeprefix}ElvMustTryAgain $(ElvTryAgain)"This installer requires admin access, try again"
	!else
	!insertmacro _UAC.TryDef UACSTR.${_modeprefix}ElvAbortReqAdmin $(ElvUnAbort)
	!insertmacro _UAC.TryDef UACSTR.${_modeprefix}ElvMustTryAgain $(ElvUnTryAgain)
	!endif
!macroend
...
LangString ElvError ${LANG_ENGLISH} "Unable to elevate , error $0"
LangString ElvError ${LANG_GERMAN} "Es ist nicht gelungen, in den Administratormodus zu wechseln, Fehler $0!"
LangString ElvAbort ${LANG_ENGLISH} "Installing JonDo requires admin access, aborting!"
LangString ElvAbort ${LANG_GERMAN} "Eine Anmeldung als Administrator ist notwendig, um JonDo zu installieren, breche ab..."
LangString ElvTryAgain ${LANG_ENGLISH} "Installing JonDo requires admin access, try again."
LangString ElvTryAgain ${LANG_GERMAN} "Eine Anmeldung als Administrator ist notwendig, um JonDo zu installieren, versuchen Sie es erneut."
LangString ElvUnAbort ${LANG_ENGLISH} "Uninstalling JonDo requires admin access, aborting!"
LangString ElvUnAbort ${LANG_GERMAN} "Eine Anmeldung als Administrator ist notwendig, um JonDo zu deinstallieren, breche ab..."
LangString ElvUnTryAgain ${LANG_ENGLISH} "Uninstalling JonDo requires admin access, try again."
LangString ElvUnTryAgain ${LANG_GERMAN} "Eine Anmeldung als Administrator ist notwendig, um JonDo zu deinstallieren, versuchen Sie es erneut."