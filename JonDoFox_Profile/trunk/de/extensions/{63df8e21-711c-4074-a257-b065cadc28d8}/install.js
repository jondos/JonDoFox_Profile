...
var displayName         = "CuteMenus"; // The name displayed to the user (don't include the version)
var version             = "1.9.1";

var name                = "cutemenus"; // The leafname of the JAR file (without the .jar part)
var jarName             = name + ".jar";

// Comment out one of the following two lines depending on your package structure.
...
var prefs               = new Array( "cutemenus.js" );
var components          = new Array( "cutemenus.js" );
...
//        registerChrome(skinFlag, folder, "skin/" + skins[i] + "/" + name + "/");
        registerChrome(skinFlag, folder, "skin/" + skins[i] + "/crystal/");
    }
