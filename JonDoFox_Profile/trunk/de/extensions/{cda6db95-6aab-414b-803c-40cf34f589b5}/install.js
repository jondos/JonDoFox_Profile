...
var XpiInstaller = {
	...
	extFullName: 'AllowClipboard Helper', // The name displayed to the user (don't include the version)
	extShortName: 'allowclipboardhelper', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.5.5',
	extAuthor: 'Petr Simek',
	extLocaleNames: ['en-US','cs-CZ','fr-FR','es-AR','es-ES','it-IT','de-DE','ja-JP','pl-PL','sk-SK','da-DK','nl-NL'], // e.g. ['en-US', 'en-GB']
