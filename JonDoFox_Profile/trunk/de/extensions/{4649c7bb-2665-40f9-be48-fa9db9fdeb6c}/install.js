...
var XpiInstaller = {
	...
	extFullName: 'SafeHistory', // The name displayed to the user (don't include the version)
	extShortName: 'stanford-safehistory', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
