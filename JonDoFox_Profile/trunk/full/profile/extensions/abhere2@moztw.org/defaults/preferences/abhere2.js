...
pref("abhere2.abhere.context" , true);
...
pref("abhere2.starUI.width"            , 400);
pref("abhere2.starUI.expand.folderRow" , true);
pref("abhere2.starUI.expand.tagsRow"   , false);
pref("abhere2.starUI.singleClick"      , false);

pref("abhere2.bmm.addBookmarkHere", false);
pref("abhere2.bmm.bookmarkCurPage", true);
pref("abhere2.bmm.bookmarkAllTabs", true);
pref("abhere2.bmm.subscribeToPage", false);
