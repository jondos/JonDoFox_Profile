...
var XpiInstaller = {
  ...
  extVersion     : '6.0a7',
  extAuthor      : 'Mel Reyes',
  extLocaleNames : ['en-US','es-ES','it-IT','fr-FR','zh-CN','pl-PL','pt-BR','de-DE','zh-TW','nl-NL','hu-HU','sr-YU','ro-RO','cs-CZ','ja','fi-FI','ru-RU','ko-KR','es-AR','mk-MK','hr-HR','da-DK','sk','lt-LT','he-IL','bg-BG','uk-UA','fa-IR','tr-TR','be-BY'],
