...
function init() {
	...
	window.setTimeout(function(){window.sizeToContent();}, 0);
...
function selectFile(storageElem, pickerTitleString) {
...
function changeColor(clickedElem) {
	...
	window.openDialog("colorPicker/EdColorPicker.xul", "_blank", "chrome,close,titlebar,modal", "", gColorObj);
	if (gColorObj.cancel)
      return;
