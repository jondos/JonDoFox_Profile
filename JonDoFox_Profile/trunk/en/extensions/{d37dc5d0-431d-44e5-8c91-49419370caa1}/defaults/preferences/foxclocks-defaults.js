...
pref("foxclocks.format.all.standard", "chrome://foxclocks/locale/defaults.properties");
pref("foxclocks.format.all.custom", "chrome://foxclocks/locale/defaults.properties");
...
pref("foxclocks.clock.tooltip.clock.global.showflag", "fc-all-clocks"); // AFM - no UI

pref("foxclocks.clock.bar.clock.new.visible", true); // AFM - no UI
pref("foxclocks.clock.bar.clock.new.showflag", false); // AFM - no UI
pref("foxclocks.clock.tooltip.clock.new.visible", true); // AFM - no UI
...
pref("foxclocks.data.update.auto.alert.enabled", true); // AFM - no UI
...
pref("foxclocks.toolbar.menuitem.hidden", false); // AFM - no UI
pref("foxclocks.watchlist.remove.confirm.enabled", true); // AFM - no UI
