...
FoxClocks_Logger.prototype =
{
	...
	log: function(message, level)
	{
		...
		{
			this._consoleService.logStringMessage(this.APP_NAME + " (" + levelString + "): " + message);
		}
		else
		{
			...
			error.init(this.APP_NAME + ": " + message, null, null, null, null, flag, null);
			this._consoleService.logMessage(error);
		}

		if (this._outStreamEnabled == true && this._outStream != null)
		{
			var messageString = this.APP_NAME + " (" + levelString + "): " + message + "\n";
