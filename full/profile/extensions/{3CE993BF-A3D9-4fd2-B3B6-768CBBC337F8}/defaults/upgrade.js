({
  ...
  "0.7.1": function upgrade_0_7_1() {
    ...
    for (var id in comp._items) {
      ...
      item.setProperty("radar.panel.label", "chrome://forecastbar/locale/forecastbar.properties"); 
      item.setProperty("radar.tooltip.enabled", true);
      item.setProperty("radar.tooltip.display", 0);
      item.setProperty("radar.tooltip.label", "chrome://forecastbar/locale/forecastbar.properties"); 
      item.setProperty("swa.panel.enabled", true);
      item.setProperty("swa.panel.display", 0);
      item.setProperty("swa.panel.label", "chrome://forecastbar/locale/forecastbar.properties"); 
      item.setProperty("swa.tooltip.enabled", true);
      item.setProperty("swa.tooltip.display", 2);
      item.setProperty("swa.tooltip.label", "chrome://forecastbar/locale/forecastbar.properties");             
      item.setProperty("swa.slider.enabled", true);
      item.setProperty("swa.slider.display", 1);
      item.setProperty("swa.slider.title", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("swa.slider.label", "chrome://forecastbar/locale/forecastbar.properties");  
      ...
      while (properties.hasMore()) {
        ...
        if (property.match("label") || property.match("title")) {
          ...
          if (value.substring(0,3) == "ff.")
            item.setProperty(property, "chrome://forecastbar/locale/forecastbar.properties");
  ...
  "0.8.1": function upgrade_0_8_1() { 
    ...
    for (var id in comp._items) {
      ...
      //add new prefs 
      item.setProperty("swa.tooltip.title", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("radar.tooltip.title", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("cc.tooltip.title", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("dayt.tooltip.title", "chrome://forecastbar/locale/forecastbar.properties");    
      item.setProperty("dayf.tooltip.title", "chrome://forecastbar/locale/forecastbar.properties");
  ...
  "0.8.2": function upgrade_0_8_2() {
    ...
    for (var id in comp._items) {
      ...
      //add new prefs 
      item.setProperty("units.degrees.0", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.degrees.1", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.pressure.0", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.pressure.1", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.temp.0", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.temp.1", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.speed.0", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.speed.1", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.dist.0", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.dist.1", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.precip.0", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.precip.1", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.percent.0", "chrome://forecastbar/locale/forecastbar.properties");
      item.setProperty("units.percent.1", "chrome://forecastbar/locale/forecastbar.properties");
  ...
  "0.9.3": function upgrade_0_9_3() { 
    ...
    for (var id in comp._items) {
      ...
      function replace(aContent) {
        ...
        if (!units || units.match("chrome://"))
          units = getBundle().GetStringFromName("forecastbar.units.current");
      ...
      for (var i=0; i<names.length; i++) {
        ...
        if (label.match("chrome://"))
          label = getBundle().GetStringFromName("forecastbar." + names[i]);
  ...
  "0.9.5": function upgrade_0_9_5() {
    // convert the default display for each profile to icon + text
    for (var id in comp._items) {
      var item = comp._items[id];
      
      item.deleteProperty("migrated.prefs");
      
      if ((item.getProperty("cc.panel.display") == 0) &&
          (item.getProperty("dayt.panel.display") == 0) &&
          (item.getProperty("dayf.panel.display") == 0)) {
        item.setProperty("cc.panel.display", 2);
        item.setProperty("dayt.panel.display", 2);
        item.setProperty("dayf.panel.display", 2);
      }
    }
