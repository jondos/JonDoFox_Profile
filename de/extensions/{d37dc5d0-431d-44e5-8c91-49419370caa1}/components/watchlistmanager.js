...
FoxClocks_WatchlistItem.prototype =
{
	...
	setStatusbarTimeFormat : function(formatString)
	{
		if (formatString != null && formatString != "")
		{
			...
			this._statusbarTimeFormatter = Components.classes["@stemhaus.com/firefox/foxclocks/timeformatter;1"]
	...
	setTooltipTimeFormat : function(formatString)
	{
		if (formatString != null && formatString != "")
		{
			...
			this._tooltipTimeFormatter = Components.classes["@stemhaus.com/firefox/foxclocks/timeformatter;1"]
							.createInstance(Components.interfaces.nsISupports).wrappedJSObject;
