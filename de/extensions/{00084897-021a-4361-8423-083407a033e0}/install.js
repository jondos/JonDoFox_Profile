...
var XpiInstaller = {
  ...
  extLocaleNames : ['en-US','bg-BG','de-DE','es-ES','fr-FR','hu-HU','it-IT','ja-JP','ko-KR','nl-NL','pl-PL','ru-RU','uk-UA','zh-CN'],
  extSkinNames   : ['classic'], // e.g., ['classic','modern']
  extPreferences : ['cookiesafe.js'], // e.g., ['extension.js']
  extComponents  : ['nsCookieSafe.js','nsICookieSafe.xpt','nsCSTempExceptions.js','nsICSTempExceptions.xpt','nsCSHiddenMenuItems.js','nsICSHiddenMenuItems.xpt','nsCSLast10Hosts.js','nsICSLast10Hosts.xpt'],
